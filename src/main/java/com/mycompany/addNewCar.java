...
public class addNewCar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Fill data to add new Car");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // taking data of new car:
        if(jTextField1.getText().isEmpty() || jTextField2.getText().isEmpty() ||jTextField3.getText().isEmpty()){
        
            JOptionPane.showMessageDialog(null, "Please enter all fields");
        }else{
            String regNumber=jTextField1.getText().trim();
            String name=jTextField2.getText().trim();
            String cost=jTextField3.getText().trim();
        
        car a=new car(regNumber,name,cost);
        a.addCar();
